...
const OrderPlaced = () => {
  ...
  return (
    <div className="mt-[64px] min-h-[1054px] flex flex-col gap-6 p-10 items-center">
      ...
      <h2 className="text-2xl font-medium text-[#2A5B45] leading-7">
      ...
      <p className="w-[346px] text-sm font-normal leading-4 text-center">
        ...
        Lo recibirás dentro de las fechas acordadas en tu envío. Hemos enviado
        un ticket a tu correo electrónico.
      </p>
      <TotalOrder />
