...
const TotalOrder = () => {
  ...
  return (
    <section className="w-[1200px] min-h-[391.32px] rounded-[10px] flex flex-col gap-6 bg-[#F7F5F3] justify-center items-center">
      ...
      <div className="w-[1152px] flex flex-col gap-4">
        ...
        <div className={`${styleSizeDetails}`}>
          <p>ENVÍO</p>
          <p className="font-semibold">{totalDelivery == "0" ? "GRATIS" : "9.00 €"}</p>
        </div>
        <hr />
        <div className={`${styleSizeDetails}`}>
